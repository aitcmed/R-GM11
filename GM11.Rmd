...
```{r}
# 原始数据
# 文静,殷成宇,廖国伟,王苑,张洁.应用GM(1,1)灰色模型预测全国甲状腺癌发病趋势[J].现代肿瘤医学,2022,30(05):899-902.
initial <- c(1.98, 2.20, 2.42, 2.98, 3.11, 2.86, 3.82, 4.08, 4.87, 6.05, 6.25)
